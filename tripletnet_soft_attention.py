...
class Tripletnet(nn.Module):
    ...
    def image_forward(self, x, y, z):
        ...
        c = x.conditions
        embedded_x, embed_norm_x, general_x = self.embeddingnet(x.images, c)
        embedded_y, embed_norm_y, general_y = self.embeddingnet(y.images, c)
        embedded_z, embed_norm_z, general_z = self.embeddingnet(z.images, c)
        ...
        return acc, loss_triplet, loss_sim_i, loss_embed, general_x, general_y, general_z
